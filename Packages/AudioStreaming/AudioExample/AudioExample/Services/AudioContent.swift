...
enum AudioContent: Int, CaseIterable {
    ...
    var streamUrl: URL {
        ...
        case .piano:
            return URL(string: "https://blueseamusics.com/rest/stream?c=SubPetal&f=json&id=6ab4d0d375658d3a5f179f74803b80a7&s=efb7f7&t=3a88ded6a4569de9ba9359eb457cfd51&u=tomcat&v=1.15.0")!//URL(string: "https://www.kozco.com/tech/piano2-CoolEdit.mp3")!
        case .local:
